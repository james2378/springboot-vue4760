...
public class RuzhutuifangView extends RuzhutuifangEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 入住状态的值
		*/
		@ColumnInfo(comment="入住状态的字典表值",type="varchar(200)")
		private String ruzhutuifangValue;
	...
	public RuzhutuifangView() {

	}

	public RuzhutuifangView(RuzhutuifangEntity ruzhutuifangEntity) {
		try {
			BeanUtils.copyProperties(this, ruzhutuifangEntity);
			...
			* 获取： 入住状态的值
			*/
			public String getRuzhutuifangValue() {
				return ruzhutuifangValue;
			}
			/**
			* 设置： 入住状态的值
			*/
			public void setRuzhutuifangValue(String ruzhutuifangValue) {
				this.ruzhutuifangValue = ruzhutuifangValue;
			}
	...
	public String toString() {
		return "RuzhutuifangView{" +
			", ruzhutuifangValue=" + ruzhutuifangValue +
