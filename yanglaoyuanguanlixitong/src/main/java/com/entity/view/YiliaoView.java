...
public class YiliaoView extends YiliaoEntity implements Serializable {
    private static final long serialVersionUID = 1L;
		...
		* 医疗类型的值
		*/
		@ColumnInfo(comment="医疗类型的字典表值",type="varchar(200)")
	...
	public YiliaoView(YiliaoEntity yiliaoEntity) {
		try {
			...
			* 获取： 医疗类型的值
			*/
			public String getYiliaoValue() {
				return yiliaoValue;
			}
			/**
			* 设置： 医疗类型的值
			*/
			public void setYiliaoValue(String yiliaoValue) {
				this.yiliaoValue = yiliaoValue;
			}
