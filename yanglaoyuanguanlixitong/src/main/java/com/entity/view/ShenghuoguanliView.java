...
public class ShenghuoguanliView extends ShenghuoguanliEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 生活管理类型的值
		*/
		@ColumnInfo(comment="生活管理类型的字典表值",type="varchar(200)")
		private String shenghuoguanliValue;
	...
	public ShenghuoguanliView() {

	}

	public ShenghuoguanliView(ShenghuoguanliEntity shenghuoguanliEntity) {
		try {
			BeanUtils.copyProperties(this, shenghuoguanliEntity);
			...
			* 获取： 生活管理类型的值
			*/
			public String getShenghuoguanliValue() {
				return shenghuoguanliValue;
			}
			/**
			* 设置： 生活管理类型的值
			*/
			public void setShenghuoguanliValue(String shenghuoguanliValue) {
				this.shenghuoguanliValue = shenghuoguanliValue;
			}
	...
	public String toString() {
		return "ShenghuoguanliView{" +
			", shenghuoguanliValue=" + shenghuoguanliValue +
