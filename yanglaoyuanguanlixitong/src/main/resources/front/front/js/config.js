...
var centerMenu = [
    ...
    {
        name: '生活管理',
        url: '../shenghuoguanli/list.html'
    },
    {
        name: '健康管理',
        url: '../jiankangguanli/list.html'
    },
    {
        name: '入住退房管理',
        url: '../ruzhutuifang/list.html'
    },
    {
        name: '医疗管理',
        url: '../yiliao/list.html'
    }
...
var adminurl =  "http://localhost:8080/yanglaoyuanguanlixitong/admin/dist/index.html#/login";
