            ...
            <div class="login-form">
                ...
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        <el-form-item label="志愿者姓名" class="input" v-if="tableName=='zhiyuanzhe'">
                            <el-input v-model="ruleForm.zhiyuanzheName" autocomplete="off" placeholder="志愿者姓名"  />
                        </el-form-item>
                        <el-form-item label="志愿者手机号" class="input" v-if="tableName=='zhiyuanzhe'">
                            <el-input v-model="ruleForm.zhiyuanzhePhone" autocomplete="off" placeholder="志愿者手机号"  />
                        </el-form-item>
                        <el-form-item label="志愿者身份证号" class="input" v-if="tableName=='zhiyuanzhe'">
                            <el-input v-model="ruleForm.zhiyuanzheIdNumber" autocomplete="off" placeholder="志愿者身份证号"  />
                        </el-form-item>
                        <el-form-item label="电子邮箱" class="input" v-if="tableName=='zhiyuanzhe'">
                            <el-input v-model="ruleForm.zhiyuanzheEmail" autocomplete="off" placeholder="电子邮箱"  />
                        </el-form-item>
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            if((!this.ruleForm.zhiyuanzheName)&& 'zhiyuanzhe'==this.tableName){
                                this.$message.error('志愿者姓名不能为空');
                                return
                            }
                             if('zhiyuanzhe' == this.tableName && this.ruleForm.zhiyuanzhePhone&&(!this.$validate.isMobile(this.ruleForm.zhiyuanzhePhone))){
                                 this.$message.error('手机应输入手机格式');
                                 return
                             }
                            if((!this.ruleForm.zhiyuanzheIdNumber)&& 'zhiyuanzhe'==this.tableName){
                                this.$message.error('志愿者身份证号不能为空');
                                return
                            }
                            if('zhiyuanzhe' == this.tableName && this.ruleForm.zhiyuanzheEmail&&(!this.$validate.isEmail(this.ruleForm.zhiyuanzheEmail))){
                                this.$message.error("邮箱应输入邮件格式");
                                return
                            }
                this.$http({
...
<style lang="scss" scoped>
	...
	.container {
		...
		background-image: url(/yanglaoyuanguanlixitong/img/back-img-bg.jpg);
