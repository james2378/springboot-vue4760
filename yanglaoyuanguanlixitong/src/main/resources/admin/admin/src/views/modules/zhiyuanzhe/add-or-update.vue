               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="志愿者姓名" prop="zhiyuanzheName">
                       <el-input v-model="ruleForm.zhiyuanzheName"
                                 placeholder="志愿者姓名" clearable  :readonly="ro.zhiyuanzheName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="志愿者手机号" prop="zhiyuanzhePhone">
                       <el-input v-model="ruleForm.zhiyuanzhePhone"
                                 placeholder="志愿者手机号" clearable  :readonly="ro.zhiyuanzhePhone"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="志愿者身份证号" prop="zhiyuanzheIdNumber">
                       <el-input v-model="ruleForm.zhiyuanzheIdNumber"
                                 placeholder="志愿者身份证号" clearable  :readonly="ro.zhiyuanzheIdNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="电子邮箱" prop="zhiyuanzheEmail">
                       <el-input v-model="ruleForm.zhiyuanzheEmail"
                                 placeholder="电子邮箱" clearable  :readonly="ro.zhiyuanzheEmail"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
        ...
        data() {
            return {
                ...
                ro:{
                    username: false,
                    password: false,
                    zhiyuanzheName: false,
                    zhiyuanzhePhone: false,
                    zhiyuanzheIdNumber: false,
                    zhiyuanzhePhoto: false,
                    sexTypes: false,
                    zhiyuanzheEmail: false,
                },
                ruleForm: {
                    username: '',
                    password: '',
                ...
                rules: {
                   ...
                   zhiyuanzhePhone: [
                              {  required: true, message: '志愿者手机号不能为空', trigger: 'blur' },
                   ...
                   zhiyuanzheIdNumber: [
                              { required: true, message: '志愿者身份证号不能为空', trigger: 'blur' },
                   ...
                   zhiyuanzhePhoto: [
                              { required: true, message: '志愿者头像不能为空', trigger: 'blur' },
                          ],
                   sexTypes: [
