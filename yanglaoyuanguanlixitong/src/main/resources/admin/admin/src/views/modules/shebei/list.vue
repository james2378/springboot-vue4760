                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/yanglaoyuanguanlixitong/upload/shebeiMuBan.xls"
                        >批量导入设备数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('shebei','导入导出')"
                    ...
                    <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign" prop="shebeiPhoto"
                        ...
                        <template slot-scope="scope">
                            <div v-if="scope.row.shebeiPhoto">
                                <img :src="scope.row.shebeiPhoto" width="100" height="100">
                            </div>
                            <div v-else>无图片</div>
                        </template>
                    </el-table-column>
