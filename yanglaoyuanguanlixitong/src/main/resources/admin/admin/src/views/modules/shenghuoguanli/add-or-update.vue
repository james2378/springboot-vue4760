    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="zhiyuanzheId" name="zhiyuanzheId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="生活管理编号" prop="shenghuoguanliUuidNumber">
                       <el-input v-model="ruleForm.shenghuoguanliUuidNumber"
                                 placeholder="生活管理编号" clearable  :readonly="ro.shenghuoguanliUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="生活管理编号" prop="shenghuoguanliUuidNumber">
                           <el-input v-model="ruleForm.shenghuoguanliUuidNumber"
                                     placeholder="生活管理编号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="生活管理名称" prop="shenghuoguanliName">
                       <el-input v-model="ruleForm.shenghuoguanliName"
                                 placeholder="生活管理名称" clearable  :readonly="ro.shenghuoguanliName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="生活管理名称" prop="shenghuoguanliName">
                           <el-input v-model="ruleForm.shenghuoguanliName"
                                     placeholder="生活管理名称" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="生活管理类型" prop="shenghuoguanliTypes">
                        <el-select v-model="ruleForm.shenghuoguanliTypes" :disabled="ro.shenghuoguanliTypes" placeholder="请选择生活管理类型">
                            <el-option
                                v-for="(item,index) in shenghuoguanliTypesOptions"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="生活管理类型" prop="shenghuoguanliValue">
                        <el-input v-model="ruleForm.shenghuoguanliValue"
                            placeholder="生活管理类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="花费金额" prop="huafeiMoney">
                       <el-input v-model="ruleForm.huafeiMoney"
                                 placeholder="花费金额" clearable  :readonly="ro.huafeiMoney"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="花费金额" prop="huafeiMoney">
                           <el-input v-model="ruleForm.huafeiMoney"
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="生活管理详情" prop="shenghuoguanliContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.shenghuoguanliContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.shenghuoguanliContent" label="生活管理详情" prop="shenghuoguanliContent">
                            <span v-html="ruleForm.shenghuoguanliContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    yonghuId: false,
                    zhiyuanzheId: false,
                    shenghuoguanliUuidNumber: false,
                    shenghuoguanliName: false,
                    shenghuoguanliTypes: false,
                    huafeiMoney: false,
                    shenghuoguanliContent: false,
                    zhixingTime: false,
                    insertTime: false,
                },
                ruleForm: {
                    yonghuId: '',
                    zhiyuanzheId: '',
                    shenghuoguanliUuidNumber: new Date().getTime(),
                    shenghuoguanliName: '',
                    shenghuoguanliTypes: '',
                    huafeiMoney: '',
                    shenghuoguanliContent: '',
                    zhixingTime: '',
                    insertTime: '',
                },
                shenghuoguanliTypesOptions : [],
                yonghuOptions : [],
                zhiyuanzheOptions : [],
                rules: {
                   yonghuId: [
                   ...
                   shenghuoguanliUuidNumber: [
                              { required: true, message: '生活管理编号不能为空', trigger: 'blur' },
                          ],
                   shenghuoguanliName: [
                              { required: true, message: '生活管理名称不能为空', trigger: 'blur' },
                          ],
                   shenghuoguanliTypes: [
                              { required: true, message: '生活管理类型不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   shenghuoguanliContent: [
                              { required: true, message: '生活管理详情不能为空', trigger: 'blur' },
                          ],
                   zhixingTime: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=shenghuoguanli_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.shenghuoguanliTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`shenghuoguanli/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.shenghuoguanliCrossAddOrUpdateFlag = false;
                                        this.parent.search();
