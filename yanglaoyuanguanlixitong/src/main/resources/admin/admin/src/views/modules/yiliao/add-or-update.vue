    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="zhiyuanzheId" name="zhiyuanzheId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="医疗管理编号" prop="yiliaoUuidNumber">
                       <el-input v-model="ruleForm.yiliaoUuidNumber"
                                 placeholder="医疗管理编号" clearable  :readonly="ro.yiliaoUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="医疗管理编号" prop="yiliaoUuidNumber">
                           <el-input v-model="ruleForm.yiliaoUuidNumber"
                                     placeholder="医疗管理编号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="医疗管理名称" prop="yiliaoName">
                       <el-input v-model="ruleForm.yiliaoName"
                                 placeholder="医疗管理名称" clearable  :readonly="ro.yiliaoName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="医疗管理名称" prop="yiliaoName">
                           <el-input v-model="ruleForm.yiliaoName"
                                     placeholder="医疗管理名称" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="医疗类型" prop="yiliaoTypes">
                        <el-select v-model="ruleForm.yiliaoTypes" :disabled="ro.yiliaoTypes" placeholder="请选择医疗类型">
                            <el-option
                                v-for="(item,index) in yiliaoTypesOptions"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="医疗类型" prop="yiliaoValue">
                        <el-input v-model="ruleForm.yiliaoValue"
                            placeholder="医疗类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="花费金额" prop="yiliaoMoney">
                       <el-input v-model="ruleForm.yiliaoMoney"
                                 placeholder="花费金额" clearable  :readonly="ro.yiliaoMoney"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="花费金额" prop="yiliaoMoney">
                           <el-input v-model="ruleForm.yiliaoMoney"
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="医疗管理备注" prop="yiliaoContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.yiliaoContent" label="医疗管理备注" prop="yiliaoContent">
                            <span v-html="ruleForm.yiliaoContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item v-if="type!='info'"  class="input" label="操作时间" prop="caozuoTime">
                        <el-date-picker
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.caozuoTime" label="操作时间" prop="caozuoTime">
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ruleForm: {
                    yonghuId: '',
                    zhiyuanzheId: '',
                    yiliaoUuidNumber: new Date().getTime(),
                    yiliaoName: '',
                    yiliaoTypes: '',
                    yiliaoMoney: '',
                    yiliaoContent: '',
                ...
                rules: {
                   ...
                   yiliaoUuidNumber: [
                              { required: true, message: '医疗管理编号不能为空', trigger: 'blur' },
                          ],
                   yiliaoName: [
                              { required: true, message: '医疗管理名称不能为空', trigger: 'blur' },
                          ],
                   yiliaoTypes: [
                              { required: true, message: '医疗类型不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   yiliaoContent: [
                              { required: true, message: '医疗管理备注不能为空', trigger: 'blur' },
                          ],
                   caozuoTime: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=yiliao_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.yiliaoTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`yiliao/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.yiliaoCrossAddOrUpdateFlag = false;
                                        this.parent.search();
