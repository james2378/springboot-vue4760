    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="zhiyuanzheId" name="zhiyuanzheId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="健康管理编号" prop="jiankangguanliUuidNumber">
                       <el-input v-model="ruleForm.jiankangguanliUuidNumber"
                                 placeholder="健康管理编号" clearable  :readonly="ro.jiankangguanliUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="健康管理编号" prop="jiankangguanliUuidNumber">
                           <el-input v-model="ruleForm.jiankangguanliUuidNumber"
                                     placeholder="健康管理编号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="健康管理名称" prop="jiankangguanliName">
                       <el-input v-model="ruleForm.jiankangguanliName"
                                 placeholder="健康管理名称" clearable  :readonly="ro.jiankangguanliName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="健康管理名称" prop="jiankangguanliName">
                           <el-input v-model="ruleForm.jiankangguanliName"
                                     placeholder="健康管理名称" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="健康状态类型" prop="jiankangguanliTypes">
                        <el-select v-model="ruleForm.jiankangguanliTypes" :disabled="ro.jiankangguanliTypes" placeholder="请选择健康状态类型">
                            <el-option
                                v-for="(item,index) in jiankangguanliTypesOptions"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="健康状态类型" prop="jiankangguanliValue">
                        <el-input v-model="ruleForm.jiankangguanliValue"
                            placeholder="健康状态类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="健康管理备注" prop="jiankangguanliContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.jiankangguanliContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.jiankangguanliContent" label="健康管理备注" prop="jiankangguanliContent">
                            <span v-html="ruleForm.jiankangguanliContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item v-if="type!='info'"  class="input" label="测量日期" prop="zhixingTime">
                        <el-date-picker
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.zhixingTime" label="测量日期" prop="zhixingTime">
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    yonghuId: false,
                    zhiyuanzheId: false,
                    jiankangguanliUuidNumber: false,
                    jiankangguanliName: false,
                    jiankangguanliTypes: false,
                    jiankangguanliContent: false,
                    zhixingTime: false,
                    insertTime: false,
                },
                ruleForm: {
                    yonghuId: '',
                    zhiyuanzheId: '',
                    jiankangguanliUuidNumber: new Date().getTime(),
                    jiankangguanliName: '',
                    jiankangguanliTypes: '',
                    jiankangguanliContent: '',
                    zhixingTime: '',
                    insertTime: '',
                },
                jiankangguanliTypesOptions : [],
                yonghuOptions : [],
                zhiyuanzheOptions : [],
                rules: {
                   yonghuId: [
                   ...
                   jiankangguanliUuidNumber: [
                              { required: true, message: '健康管理编号不能为空', trigger: 'blur' },
                          ],
                   jiankangguanliName: [
                              { required: true, message: '健康管理名称不能为空', trigger: 'blur' },
                          ],
                   jiankangguanliTypes: [
                              { required: true, message: '健康状态类型不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   jiankangguanliContent: [
                              { required: true, message: '健康管理备注不能为空', trigger: 'blur' },
                          ],
                   zhixingTime: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=jiankangguanli_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.jiankangguanliTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`jiankangguanli/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.jiankangguanliCrossAddOrUpdateFlag = false;
                                        this.parent.search();
